...
// few numbers separated by a hyphen. Work out if the numbers
// are consecutive. For example, if the input is "5-6-7-8-9"
// or "20-19-18-17-16", display a message: "Consecutive";
// otherwise, display "Not Consecutive".

using Exercise4_String;

var numbers =   "5-6-7-8-9" ;
//numbers = "20-19-18-17-16";
//numbers = "1-2-4-3-5";
var isConsecutive = Ex1.isConsecutive(numbers);
...
// "NumberOfStudents". Make sure that the program is not dependent
// on the input. So, if the user types "NUMBER OF STUDENTS",
// the program should still display "NumberOfStudents".

//string words = "NUMBER OF STUDENTS";
//string result = Ex4.CreatePascalCase(words);
//Console.WriteLine(result);

// 5- Write a program and ask the user to enter an English word.
// Count the number of vowels (a, e, o, u, i) in
// the word. So, if the user enters "inadequate",
// the program should display 6 on the console.
string input = "inadequate";
Console.WriteLine(Ex6.CountVowels(input));
